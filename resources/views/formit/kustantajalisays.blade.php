        ...
        <div class="card-body">
            <form action="{{ action('KustantajaController@store') }}" method="POST">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input class="form-control" name="nimi" type="text" placeholder="Kustantajan nimi">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-lg-3 col-form-label form-control-label">Kotipaikka</label>
                    <div class="col-lg-9">
                        <input class="form-control" name="kotipaikka" type="text" placeholder="Kustantajan kotipaikka">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-lg-3 col-form-label form-control-label">Perustamisvuosi</label>
                    <div class="col-lg-9">
                        <input class="form-control" name="perustamisvuosi" type="number" placeholder="1920">
                    </div>
                </div>
                <div class="form-group row">
                        <label class="col-lg-3 col-form-label form-control-label">Lopettamisvuosi</label>
                        <div class="col-lg-9">
                            <input class="form-control" name="lopettamisvuosi" type="number" placeholder="1990">
                        </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        ...
                        <input type="button" class="btn btn-secondary onclick="location.href="{{ url('kustantajat') }}" placeholder="Peruuta">
                    </div>
                </div>
            </form>
        </div>
